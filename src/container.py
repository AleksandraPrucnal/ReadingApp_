...
from src.infrastructure.repositories.preferences_repository import PreferencesRepository
...
from src.infrastructure.services.preferences import PreferencesService
...
class Container(DeclarativeContainer):
    ...
    preferences_repository = Singleton(PreferencesRepository)
