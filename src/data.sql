...
(1, 'Wesoły kotek\nTo jest kotek Mruczek. Mruczek jest mały i czarny. Ma białe łapki. Kotek bawi się kłębkiem wełny. Wełna jest czerwona. Mruczek jest bardzo wesoły.', ARRAY['http://10.0.2.2:8000/static/placeholder.png', 'http://10.0.2.2:8000/static/placeholder.png', 'http://10.0.2.2:8000/static/placeholder.png'], 0),
